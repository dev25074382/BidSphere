          ...
          <div className="flex gap-4 my-8">
            {!isAuthenticated && (
              <>
                ...
                <Link
                  to={"/login"}
                  className="text-[#d6482b] bg-transparent border-[#682720] border-2  hover:text-[#682720] hover:transition-all hover:duration-150 font-bold text-xl  rounded-md px-8 flex items-center py-2 transition-all duration-300"
                >
                  Login
                </Link>
              </>
