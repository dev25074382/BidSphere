          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row ">
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">Full Name</label>
                <input
                  type="text"
                  value={fullName}
              ...
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">Email</label>
                <input
                  type="email"
                  value={email}
            ...
            <div className="flex flex-col gap-4 sm:flex-row ">
              ...
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">Address</label>
                <input
                  type="text"
                  value={address}
            ...
            <div className="flex flex-col gap-4 sm:flex-row ">
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">Role </label>
                <select
                  value={role}
              ...
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">Password</label>
                <input
                  type="password"
                  value={password}
            ...
            <div className="flex flex-col gap-4 sm:flex-row ">
              <div className="flex flex-col sm:flex-1">
                <label className="text-xl text-stone-600">UserName</label>
                <input
                  type="text"
                  value={username}
              ...
              <div className=" flex flex-col sm:flex-1 gap-2">
                <label className="text-xl text-stone-600 ">Profile Image</label>
